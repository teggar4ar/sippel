<div class="space-y-3 overflow-x-hidden">
    ...
    <div x-data="{ show: false }" x-on:profile-saved.window="show = true; setTimeout(() => show = false, 3000)"
    ...
    <x-ui.section-heading variant="teacher" title="Profil Saya"
    ...
    <x-ui.card variant="teacher" title="Profil Saya" icon="user-circle">
        ...
        <form wire:submit="updateProfile" class="space-y-6">
            <div
                class="flex flex-col sm:flex-row sm:items-center gap-4 rounded-xl bg-blue-50/70 dark:bg-blue-950/20 border border-blue-100 dark:border-blue-900/40 p-4">
                <div
                    class="flex h-14 w-14 shrink-0 items-center justify-center rounded-full bg-blue-600 text-white text-xl font-bold shadow-sm">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <p class="text-xs text-slate-500 dark:text-slate-400 mt-0.5">(Kosongkan jika tidak ingin mengubah
                        password)</p>
                </div>
