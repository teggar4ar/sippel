<div class="space-y-4">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-3">
        <x-ui.metric-card
            ...
            short-label="Mapel"
            :value="$this->dashboardStats['kelas_diampu']"
            unit="Mapel"
        ...
        <x-ui.metric-card
            label="Total Siswa"
            short-label="Siswa"
            :value="$this->dashboardStats['total_siswa']"
            unit="Siswa"
            icon="user-group"
            accent="emerald"
        />
        <x-ui.metric-card
            ...
            short-label="Minggu Ini"
            :value="$this->dashboardStats['aktivitas_minggu_ini']"
            unit="Aktivitas"
        ...
        <x-ui.metric-card
            ...
            short-label="Kehadiran"
            :value="$this->dashboardStats['rata_kehadiran']"
            unit="%"
            icon="hand-raised"
            accent="amber"
        />
