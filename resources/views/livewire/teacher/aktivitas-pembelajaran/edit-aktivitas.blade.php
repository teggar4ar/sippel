<div class="space-y-4 overflow-x-hidden">
    ...
    <div class="flex items-center gap-3">
        ...
        <div>
            <h1 class="text-lg font-bold text-slate-900 dark:text-white leading-tight">Edit Aktivitas</h1>
            <p class="text-xs text-slate-500 dark:text-slate-400">Ubah data aktivitas pembelajaran</p>
        </div>
    </div>
                    ...
                    <flux:select wire:model.live="mataPelajaranId" label="Mata Pelajaran *"
                        ...
                        @foreach ($this->mataPelajaran as $mapel)
                            <option value="{{ $mapel->id }}">{{ $mapel->nama_mapel }} —
                                {{ $mapel->kelas->nama_lengkap }}</option>
                        @endforeach
                    </flux:select>
    ...
    <div x-data="{
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-xs text-slate-500 dark:text-slate-400">Perbarui kehadiran dan tingkat keaktifan
                    ({{ $this->siswaList->count() }} siswa)</p>
            </div>
                ...
                <div class="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm relative"
                    ...
                    <div class="flex flex-col gap-2.5 px-3 py-3 lg:flex-row lg:items-center lg:gap-3 lg:px-4">
                        ...
                        <div class="flex gap-1.5 lg:gap-1 lg:flex-1"
                            ...
                            x-transition:enter="transition-opacity duration-100" x-transition:enter-start="opacity-0"
        ...
        {{-- Note Modal --}}
        <flux:modal name="note-modal-edit" class="md:w-[460px]">
            <div class="space-y-5">
                <div class="flex items-center gap-3">
                    <div
                    ...
                    <div class="flex-1 min-w-0">
                        <p class="text-[10px] font-semibold uppercase tracking-widest text-slate-400">Catatan Observasi
                        </p>
                ...
                <div class="flex gap-2 justify-end pt-1">
                    ...
                    <flux:button variant="primary" size="sm" x-on:click="saveNote()" class="cursor-pointer">
