...
final class MataPelajaranForm
{
    public static function configure(Schema $schema): Schema
    {
        return $schema
            ->columns(2)
            ->components([
                self::buildNamaMapelField(),
                self::buildTingkatKelasField(),
                self::buildKelasField(),
                self::buildGuruField(),
                self::buildApplyToGroupsSection(),
            ])
            ->statePath('data');
    }

    private static function buildNamaMapelField(): TextInput
    {
        return TextInput::make('nama_mapel')
    ...
    private static function buildTingkatKelasField(): Select
    {
        return Select::make('tingkat_kelas')
            ->label('Tingkat Kelas')
            ->options([
                '7' => 'Kelas 7',
                '8' => 'Kelas 8',
    ...
    private static function buildKelasField(): Select
    {
        return Select::make('kelas_id')
            ->label('Kelas')
    ...
    private static function buildGuruField(): Select
    {
        return Select::make('guru_id')
            ->label('Guru Pengampu')
            ->relationship(
                name: 'guru',
                titleAttribute: 'name',
    ...
    private static function buildApplyToGroupsSection(): Section
    {
