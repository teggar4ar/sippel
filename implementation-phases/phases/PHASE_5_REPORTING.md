...
- [ ] **5.1.1** Create command: `php artisan make:command CalculateReports`
...
- [ ] **5.1.2** Schedule command to run daily: Add to `app/Console/Kernel.php`

- [ ] **5.1.3** Add manual trigger button in Admin panel: Custom action "Perbarui Laporan"

- [ ] **5.1.4** Test calculation accuracy with sample data

---

## Task 5.2: Report layout design

- [ ] **5.2.1** Create Blade view: `resources/views/reports/student-report.blade.php`
...
- [ ] **5.2.2** Create Blade view: `resources/views/reports/class-report.blade.php`
...
- [ ] **5.2.3** Add CSS styling for print-friendly layout

- [ ] **5.2.4** Test views with sample data

---

## Task 5.3: Student report generation (Teacher & Admin)

- [ ] **5.3.1** Create custom page: `app/Filament/Pages/StudentReport.php`
  - Purpose: Generate student report from cached `laporan` data
  - Form: Select student, select academic year (default: active)

- [ ] **5.3.2** Create controller method: `generateStudentReport()`
...
- [ ] **5.3.3** Add DomPDF integration:
  - Note: DomPDF already installed in Phase 1 ✅
  - Configure PDF options (paper size: A4, orientation: portrait)
  - Generate PDF from Blade view

- [ ] **5.3.4** Add download action: Return PDF as download

- [ ] **5.3.5** Test report generation with cached laporan data

---

## Task 5.4: Class report generation (Teacher & Admin)

- [ ] **5.4.1** Create custom page: `app/Filament/Pages/ClassReport.php`
...
- [ ] **5.4.2** Create controller method: `generateClassReport()`
...
- [ ] **5.4.3** Add sorting options: Sort by name, attendance, or grade

- [ ] **5.4.4** Add PDF export using DomPDF

- [ ] **5.4.5** Test class report with full class data

---

## Task 5.5: Report access in Student panel (Flux UI)

- [ ] **5.5.1** Create Livewire component for student reports:
  ```bash
  php artisan make:livewire Student/LaporanSaya
  ```

- [ ] **5.5.2** Build mobile-optimized report interface with Flux UI:
  ```blade
  <div class="space-y-6">
...
- [ ] **5.5.3** Implement download method in Livewire:
  ```php
...
- [ ] **5.5.4** Test student self-report generation on mobile

---

## Task 5.6: Report accuracy testing

- [ ] **5.6.1** Create test data: 3 students, 10 activities each per subject

- [ ] **5.6.2** Run CalculateReports command to populate `laporan` table

- [ ] **5.6.3** Manually calculate expected values

- [ ] **5.6.4** Generate reports and verify calculations match

- [ ] **5.6.5** Test edge cases:
...
- [ ] **5.6.6** Fix any calculation discrepancies

---

## ✅ Phase 5 Completion Checklist

- [ ] CalculateReports command created and scheduled
- [ ] Laporan table populated with cached statistics
- [ ] Student report Blade template created
- [ ] Class report Blade template created
- [ ] Report styling is print-friendly
- [ ] DomPDF configured and working
- [ ] Student report generation functional (uses laporan table)
- [ ] Class report generation functional (uses laporan table)
- [ ] Student can generate personal reports
- [ ] Teacher can generate student reports
- [ ] Teacher can generate class reports
- [ ] All calculations are accurate
- [ ] PDF download working properly
- [ ] Reports generated in < 2 seconds (thanks to cached data)
